//
// 맵 관리 클래스.
// 간략화하기 위해 블록의 크기는 1로 고정하고, 배치는 정수의 좌표에 1로 스냅되도록 한다.
//
using UnityEngine;
...
public class Map : MonoBehaviour {
	...
	private const float WALL_Y = 0.0f;  // 벽의 블록을 배치할 Y좌표.
	...
	public Vector3 GetSpawnPoint(int type)  // TODO: 차이를 위의 함수와 비교하기 어렵다.
	{
