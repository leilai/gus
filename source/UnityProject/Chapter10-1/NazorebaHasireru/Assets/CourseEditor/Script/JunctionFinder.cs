...
public class JunctionFinder {
	...
	public StaticArray<Junction>	junctions;

	// ------------------------------------------------------------------------------------------------ //

	public void	create()
	{
		this.junctions = new StaticArray<Junction>(16);
	}
	...
	public void	findJunction()
	{
		...
		for(int i = 0;i < this.position_num - 2;i++) {
			...
			for(int j = i + 2;j < this.position_num - 1;j++) {
				...
				this.junctions.push_back(this.junction);
