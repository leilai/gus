...
public class CarSoundControl_ : MonoBehaviour {
	...
	private bool	is_contact_wall = false;		// 壁ヒットした？.
	private float	wall_hit_timer = 0.0f;			// 壁ヒット後タイマー.
	private float	hit_speed_wall = 0.0f;			// 壁にヒットしたスピード.

	private bool	is_landing = false;					// 着地した？.
	private float	landing_timer = 0.0f;			// 着地後タイマー.
	private float	landing_speed = 0.0f;			// 着地したスピード.
